...
<!-----------------address------------------------------->
<div class="address">
    <div class="wrapper clearfix"><a href="/wwqShop/indexselect">首页</a>
        <span>/</span><a href="selectproductlist?cid=${cate.cate_id}">${cate.cate_name}</a>
        <span>/</span><a href="#" class="on">${p.product_name}</a>
    </div>
</div><!-----------------------Detail------------------------------>
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="${p.product_filename}"/>
                <div class="smallImg clearfix"><img src="${p.product_filename}"
            ...
            <div class="fr intro">
                ...
                <div class="proIntro"><p>颜色分类</p>
                    <div class="smallImg clearfix categ"><p class="fl"><img src="${p.product_filename}"
                                                                            alt="白瓷花瓶+20支快乐花"
                                                                            data-src="${p.product_filename}"></p>
        ...
        <div class="seeList">
            ...
            <c:forEach var="c" items="${classlist}">
                <a href="selectproductview?id=${c.product_id}">
                    <dl>
                        <dt><img src="${c.product_filename}"></dt>
                        <dd>【最家】${c.product_name}</dd>
                        <dd>￥${c.product_price}.00</dd>
                    </dl>
                </a>
            </c:forEach>
    ...
    <div class="bottom">
        ...
        <div class="imgCon bd">
            <div class="likeList clearfix">
                ...
                <c:forEach var="las" items="${lastlylist}">
                    <a href="selectproductview?id=${las.product_id}">
                    <dl>
                        <dt><img src="${las.product_filename}"></dt>
                        <dd>【最家】${las.product_name}</dd>
                        <dd>￥${las.product_price}.00</dd>
                    </dl>
                </a>
                </c:forEach>
